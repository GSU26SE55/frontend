...
import { changeAccountRoleSchema, type ChangeAccountRoleFormValues } from '@/features/admin/schemas/admin-account.schema';
      ...
      <DialogContent className="sm:max-w-sm">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            <Label>Role mới <span className="text-red-500">*</span></Label>
            <Controller
              name="roleId"
              control={control}
              render={({ field }) => (
