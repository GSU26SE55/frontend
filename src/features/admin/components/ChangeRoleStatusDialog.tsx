...
import { changeRoleStatusSchema, type ChangeRoleStatusFormValues } from '@/features/admin/schemas/role.schema';
      ...
      <DialogContent className="sm:max-w-xs">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 py-2">
          <p className="text-sm text-muted-foreground">
            Role: <span className="font-medium text-foreground">{role.name}</span>
          </p>
