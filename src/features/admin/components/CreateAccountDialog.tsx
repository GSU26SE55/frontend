...
import { createAccountSchema, type CreateAccountFormValues } from '@/features/admin/schemas/admin-account.schema';
...
export default function CreateAccountDialog({ open, onClose }: Props) {
  ...
  const handleClose = () => { reset(); setShowPw(false); setShowConfirm(false); onClose(); };
