...
import { siteFormSchema, type SiteFormValues } from '@/features/admin/schemas/site.schema';
import { useCreateSite, useUpdateSite } from '@/features/admin/hooks/useSites';
import { SiteStatusEnum, type SiteDto, type SiteCreatePayload } from '@/shared/types/site.types';
...
export default function SiteFormDialog({ open, onOpenChange, editData }: SiteFormDialogProps) {
      ...
      <DialogContent className="max-w-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <Input id="customerId" {...register('customerId')} placeholder="UUID" />
          ...
          <div className="space-y-1">
            ...
            {errors.installDate && <p className="text-sm text-destructive">{errors.installDate.message}</p>}
          </div>
          ...
          <div className="space-y-1">
            ...
            <Input id="capacityKw" type="number" step="any" {...register('capacityKw')} />
            {errors.capacityKw && <p className="text-sm text-destructive">{errors.capacityKw.message}</p>}
          </div>
