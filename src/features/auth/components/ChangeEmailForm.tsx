...
const ChangeEmailForm = () => {
  ...
  const otpForm = useForm<ConfirmOtpFormValues>({ resolver: zodResolver(confirmOtpSchema) });
      ...
      <CardContent>
        {step === 1 ? (
          ...
          <form onSubmit={otpForm.handleSubmit(onOtpSubmit)} className="space-y-4">
            <p className="text-sm text-muted-foreground">Nhập mã OTP đã gửi đến email mới của bạn.</p>
            <div className="space-y-1">
              <Label>Mã OTP</Label>
