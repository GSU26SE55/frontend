  ...
  if (!token) {
    return (
      <div className="space-y-3 text-center">
        <h1 className="text-xl font-bold tracking-tight text-slate-900">Liên kết không hợp lệ</h1>
        <p className="text-sm text-slate-500">
          Liên kết mời không hợp lệ hoặc đã hết hạn. Vui lòng liên hệ Admin để được gửi lại.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-5">
      <div className="space-y-1">
        <h1 className="text-xl font-bold tracking-tight text-slate-900">Kích hoạt tài khoản</h1>
        <p className="text-sm text-slate-500">Đặt mật khẩu để hoàn tất kích hoạt tài khoản</p>
      </div>
