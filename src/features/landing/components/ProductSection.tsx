      ...
      <Reveal>
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          <div className="max-w-2xl">
            <p className="mb-3 text-sm font-semibold uppercase tracking-wider text-emerald-700">Gói sản phẩm</p>
              ...
              <div className="group flex flex-col h-full bg-white transition-all duration-300">
                ...
                <div className="flex flex-col flex-1 mt-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-slate-100 text-xs">
                    <div>
                      <span className="block font-semibold tracking-wider text-slate-400 uppercase">Metric:</span>
                      <span className="block mt-1.5 font-medium text-slate-700 leading-normal">{item.metric}</span>
                    </div>
                    <div>
                      <span className="block font-semibold tracking-wider text-slate-400 uppercase">Ideal for:</span>
                      <span className="block mt-1.5 font-medium text-slate-700 leading-normal">{item.idealFor}</span>
                    </div>
                  </div>
                </div>
