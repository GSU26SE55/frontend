...
const LoginStep = ({
  ...
  return (
    <StaggerForm onSubmit={handleSubmit(onSubmit)}>
      ...
      <Item>
        <PillButton isPending={isPending}>
          Đăng nhập <Send className="size-4" />
        </PillButton>
      </Item>
      <Item>
        <OrDivider />
...
const RegisterStep = ({
  ...
  return (
    <StaggerForm onSubmit={handleSubmit(onSubmit)}>
      ...
      <Item>
        <PillButton isPending={isPending}>
          Tạo tài khoản <Send className="size-4" />
        </PillButton>
      </Item>
      <Item>
        <p className="text-center text-xs text-muted-foreground">
...
const OtpVerifyStep = ({
  ...
  return (
    <StaggerForm
      onSubmit={handleSubmit((data) => verify({ email, otp: data.otp }))}
    >
      <Item>
      ...
      <Item>
        <PillButton isPending={isPending}>
          Xác thực <ShieldCheck className="size-4" />
        </PillButton>
      </Item>
      <Item>
        <ResendButton
...
const ForgotStep = ({ onSuccess }: { onSuccess: (email: string) => void }) => {
  ...
  return (
    <StaggerForm onSubmit={handleSubmit((data) => mutate(data))}>
      ...
      <Item>
        <PillButton isPending={isPending}>
          Gửi mã OTP <Send className="size-4" />
        </PillButton>
      </Item>
    </StaggerForm>
  );
...
const ResetOtpStep = ({
  ...
  return (
    ...
    >
      ...
      <Item>
        <PillButton isPending={isPending}>
          Xác nhận <ShieldCheck className="size-4" />
        </PillButton>
      </Item>
      <Item>
        <ResendButton
...
const ResetPasswordStep = ({
  ...
  return (
    <StaggerForm onSubmit={handleSubmit(onSubmit)}>
      ...
      <Item>
        <PillButton isPending={isPending}>
          Đặt lại mật khẩu <Send className="size-4" />
        </PillButton>
      </Item>
    </StaggerForm>
  );
...
const LoginDialog = ({ open, onOpenChange }: LoginDialogProps) => {
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case "otp-verify":
        return (
          <OtpVerifyStep email={email} onSuccess={() => goTo("login", -1)} />
        );
      case "forgot":
        return (
          <ForgotStep
          ...
          {
            {
              login: "Đăng nhập",
              register: "Đăng ký",
              "otp-verify": "Xác thực OTP",
              forgot: "Quên mật khẩu",
              "reset-otp": "Xác thực OTP",
