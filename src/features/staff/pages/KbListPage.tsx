...
export default function KbListPage() {
  ...
  return (
    <PageContainer>
      ...
      <div className="sticky top-0 z-10 -ml-(--page-pl) mr-[calc(var(-mr-(--page-pr)l) pr-(--page-pr) bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/70 space-y-3">
